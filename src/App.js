...
import MaketingReport from './pages/MaketingReport';
import FaceBookReport from './pages/MaketingReport/FaceBookReport';
            ...
            <Header>
              <Content>
                <Switch>
                  ...
                  <PrivateRoute exact path="/dasboard/maketingreport" component={MaketingReport} />
                  <PrivateRoute exact path="/dasboard/maketingreport/facebookreport" component={FaceBookReport} />
